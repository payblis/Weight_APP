-- Fichier SQL pour l'export de la base de données de l'application de suivi de perte de poids
-- Créé le 22 mars 2025

-- Suppression des tables existantes si elles existent
DROP TABLE IF EXISTS targeted_recommendations;
DROP TABLE IF EXISTS morphological_analyses;
DROP TABLE IF EXISTS program_activity_recommendations;
DROP TABLE IF EXISTS program_meal_recommendations;
DROP TABLE IF EXISTS custom_programs;
...
('utilisateur_test', 'test@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi');

-- Insérer un profil pour l'utilisateur de test
INSERT INTO user_profiles (user_id, gender, age, height, initial_weight, target_weight, activity_level) VALUES
(1, 'homme', 35, 175, 85, 75, 'modérément actif');

-- Insérer des enregistrements de poids pour l'utilisateur de test
INSERT INTO weight_logs (user_id, weight, log_date, notes) VALUES
(1, 85, '2025-03-01', 'Poids initial'),
(1, 84.5, '2025-03-08', 'Première semaine'),
(1, 83.8, '2025-03-15', 'Deuxième semaine'),
(1, 83.2, '2025-03-22', 'Troisième semaine');

-- Insérer des enregistrements d'activités pour l'utilisateur de test
INSERT INTO activity_logs (user_id, activity_id, duration_minutes, log_date, calories_burned, notes) VALUES
(1, 1, 30, '2025-03-15', 150, 'Marche matinale'),
(1, 2, 20, '2025-03-16', 200, 'Jogging au parc'),
(1, 5, 45, '2025-03-18', 187.5, 'Séance de yoga'),
(1, 7, 40, '2025-03-20', 266.7, 'Musculation');

-- Insérer des enregistrements de repas pour l'utilisateur de test
INSERT INTO meal_logs (user_id, meal_id, meal_name, calories, log_date, meal_time, notes) VALUES
(1, 1, NULL, 350, '2025-03-22', 'petit-déjeuner', 'Bon petit-déjeuner énergétique'),
(1, 4, NULL, 400, '2025-03-22', 'déjeuner', 'Repas équilibré'),
(1, 7, NULL, 400, '2025-03-22', 'dîner', 'Dîner léger'),
(1, 10, NULL, 200, '2025-03-22', 'collation', 'Collation après l\'entraînement');

-- Insérer un programme personnalisé pour l'utilisateur de test
INSERT INTO custom_programs (user_id, name, description, start_date, end_date, daily_calorie_target) VALUES
(1, 'Programme de perte de poids', 'Programme personnalisé pour perdre 10kg en 3 mois', '2025-03-01', '2025-06-01', 1800);

-- Insérer une configuration d'API (clé fictive)
INSERT INTO api_config (api_key) VALUES
('sk-example123456789abcdefghijklmnopqrstuvwxyz');
